...
<div class="row">
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning about how to use GraphDiff with our getting started tutorial.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning the common API of GraphDiff, and everything around it.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning GraphDiff best practices and solution to the common problem you may encounter.</p>
			<p class="lead">
