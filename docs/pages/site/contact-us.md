...
The best way to report an issue is using our [Issues Tracker](https://github.com/zzzprojects/GraphDiff/issues){:target="_blank"}
...
The best way to request a new feature is using our [Issues Tracker](https://github.com/zzzprojects/GraphDiff/issues){:target="_blank"}
		...
		<div class="col-lg-4 order-1 order-lg-2">
			<div class="card card-layout-z1 wow slideInRight">
				...
				<div class="card-body">
					...
					<a href="https://github.com/zzzprojects/GraphDiff/issues" target="_blank">Issues Tracker</a>
				</div>
			</div>
			<br /><br />
		</div>
